...
import com.example.mask_app_android_2.util.OkHttpUtil
import com.example.mask_app_android_2.util.OkHttpUtil.Companion.mOkHttpUtil
...
//        OkHttpUtil_var.getAsync(pharmaciesDataUrl, object : Okhttp3util.ICallback
//        {
//            //收到回應資料邏輯區塊
...
//        })
        ...
        mOkHttpUtil.getAsync(PHARMACIES_DATA_URL, object : OkHttpUtil.ICallback {
            override fun onResponse(response: Response) {
                ...
                runOnUiThread {
                    binding.tvPharmacyData.text = propertiesName
